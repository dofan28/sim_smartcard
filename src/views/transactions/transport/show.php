...
$transaction = getTransactionTransportById($db, $transactionId);
?>
...
<main class="container px-6 py-12 mx-auto">
    <!-- Header -->
    <header class="mb-8">
        <h1 class="text-3xl font-semibold tracking-wide text-blue-900 font-poppins">Detail Data Log Akses Transportasi</h1>
        <p class="mt-2 text-sm text-gray-700 font-poppins">Berikut adalah informasi lengkap dari log akses transportasi yang dipilih.</p>
    </header>
    ...
    <div class="p-6 mt-6 bg-white rounded-md shadow-md">
        ...
        <div class="flex items-center justify-between mt-6">
            ...
            <div class="flex space-x-2">
                <a href="/transaction/transports/<?= $transaction['id'] ?>/edit"
                    class="px-4 py-2 text-sm text-white bg-blue-500 rounded-md font-poppins hover:bg-blue-600">
                    Edit
                </a>
                <a href="/transaction/transports/<?= $transaction['id'] ?>/delete"
