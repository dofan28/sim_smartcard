...
$transaction = getTransactionGateById($db, $transactionId);
?>
...
<main class="container px-6 py-12 mx-auto">
    <!-- Header -->
    <header class="mb-8">
        <h1 class="text-3xl font-semibold tracking-wide text-blue-900 font-poppins">Detail Data Log Akses Gerbang</h1>
        <p class="mt-2 text-sm text-gray-700 font-poppins">Berikut adalah informasi lengkap dari log akses gerbang yang dipilih.</p>
    </header>
        ...
        <table class="w-full border border-collapse border-gray-300 rounded-md">
            <tbody>
                ...
                <tr class="border-b border-gray-300">
                    ...
                    <td class="px-4 py-2 text-gray-600" id="phone"><?= htmlspecialchars($transaction['phone']) ?></td>
                </tr>
    ...
    <div class="p-6 mt-6 bg-white rounded-md shadow-md">
        <h2 class="mb-6 text-3xl font-semibold text-blue-800 uppercase font-poppins" id="nama-siswa">Data Log Akses Gerbang</h2>
        <table class="w-full border border-collapse border-gray-300 rounded-md">
            <tbody>
                <tr class="border-b border-gray-300">
                    <td class="px-4 py-2 text-sm font-semibold text-gray-700 font-poppins">Tanggal Log Akses Gerbang:</td>
        ...
        <div class="flex items-center justify-between mt-6">
            ...
            <div class="flex space-x-2">
                <a href="/transaction/gates/<?= $transaction['id'] ?>/edit"
                    class="px-4 py-2 text-sm text-white bg-blue-500 rounded-md font-poppins hover:bg-blue-600">
                    Edit
                </a>
                <a href="/transaction/gates/<?= $transaction['id'] ?>/delete"
