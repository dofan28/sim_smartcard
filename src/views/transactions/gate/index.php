...
$transactionGates = getAllTransactionGateJoinStudentPaginated($db, $limit, $offset, $search);
$totalTransactionGates = getTotalTransactionGates($db, $search);
$totalPages = ceil($totalTransactionGates / $limit);
$no = $offset + 1;
        ...
        <div class="flex items-center gap-4 p-4 bg-white rounded-md shadow">
            ...
            <div class="relative inline-block text-left">
                ...
                <div id="dropdownMenu" class="absolute right-0 hidden mt-2 bg-white divide-y divide-gray-100 shadow-lg w-72 rounded-xl ring-1 ring-black/5">
                    <div class="p-1">
                        <!-- PDF Option -->
                        <a href="/transaction/gate/print/pdf" class="flex items-center px-2 py-3 text-sm text-gray-700 transition-all duration-200 rounded-md hover:bg-red-200 group">
                        ...
                        <!-- Excel Option -->
                        <a href="/transaction/gate/print/excel" class="flex items-center px-2 py-3 text-sm text-gray-700 transition-all duration-200 rounded-md hover:bg-green-200 group">
