        ...
        <div class="flex items-center gap-4 p-4 bg-white shadow rounded-md">
            ...
            <div class="relative inline-block text-left">
                ...
                <div id="dropdownMenu" class="hidden absolute right-0 mt-2 w-72 rounded-xl bg-white shadow-lg ring-1 ring-black/5 divide-y divide-gray-100">
                    <div class="p-1">
                        <!-- PDF Option -->
                        <a href="/transaction/class/print/pdf" class="flex items-center px-2 py-3 text-sm text-gray-700 hover:bg-red-200 rounded-md transition-all duration-200 group">
                        ...
                        <!-- Excel Option -->
                        <a href="/transaction/class/print/excel" class="flex items-center px-2 py-3 text-sm text-gray-700 hover:bg-green-200 rounded-md transition-all duration-200 group">
