...
<section class="bg-gray-100">
    <div class="container flex flex-col items-center px-6 py-12 mx-auto lg:flex-row lg:space-x-12">
        <div class="text-center lg:w-1/2 lg:text-left">
            ...
            <a href="/login"
                class="mt-6 px-3 py-2 font-poppins text-sm font-medium hover:bg-amber-600 hover:font-semibold text-white rounded-md bg-amber-400">
                Memulai
            </a>
        </div>
        <div class="mt-8 lg:w-1/2 lg:mt-0">
            <img src="assets/images/vektor-card.png"
                alt="Ilustrasi Smart Card"
                class="w-3/4 max-w-sm mx-auto lg:w-full">
        </div>
    </div>
</section>