            ...
            if ($transactionClass) {
                if (!$transactionClass['check_out']) {
                    ...
                    if ($timeDifference >= 10) {
                        $data = updateCheckout($db, $transactionClass['id']);
                        ...
                        $subject  = 'Report Jam Pulang: Akses Kelas';

                        $message = "
                <html>
                <head>
                    <title>Report Jam Pulang: Akses Kelas</title>
                    <style>
                        body {
                ...
                <body>
                    ...
                    <p style=\"color: #000000;\"><b style=\"color: #000000;\">Jenis Transaksi:</b> <span style=\"color: #000000;\">Kelas</span><br>
                    ...
                    <p style=\"color: #000000;\">Terima kasih telah menggunakan layanan kelas sekolah.</p>
                ...
                $data = createTransactionClass($db, $studentId);
                ...
                $to       = $student['email'] ?? 'N/A';
                $subject  = 'Report Jam Masuk: Akses Kelas';

                $message = "
        <html>
        <head>
            <title>Report Jam Masuk: Akses Kelas</title>
            <style>
                body {
                    color: #000000; /* Warna hitam untuk seluruh teks */
                    font-family: Arial, Helvetica, sans-serif;
