            ...
            if ($transactionGate) {
                if (!$transactionGate['check_out']) {
                    ...
                    if ($timeDifference >= 10) {
                        $data = updateCheckout($db, $transactionGate['id']);
                        ...
                        $subject  = 'Report Jam Pulang: Akses Gerbang';

                        $message = "
                    <html>
                    <head>
                        <title>Report Jam Pulang: Akses Gerbang</title>
                        <style>
                            body {
                    ...
                    <body>
                        ...
                        <p style=\"color: #000000;\"><b style=\"color: #000000;\">Jenis Transaksi:</b> <span style=\"color: #000000;\">Gerbang</span><br>
                        ...
                        <p style=\"color: #000000;\">Terima kasih telah menggunakan layanan gerbang sekolah.</p>
                ...
                $data = createTransactionGate($db, $studentId);
                ...
                $to       = $student['email'] ?? 'N/A';
                $subject  = 'Report Jam Masuk: Akses Gerbang';

                $message = "
            <html>
            <head>
                <title>Report Jam Masuk: Akses Gerbang</title>
                <style>
                    body {
                        color: #000000; /* Warna hitam untuk seluruh teks */
                        font-family: Arial, Helvetica, sans-serif;
